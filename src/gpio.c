...
gpio_t pin_ins[] = {
	...
	{SWITCH_LGEN, GPIOD, GPIO10,  GPIO_PUPD_PULLUP, ACTIVE_LOW, DEBOUNCE_LOW}, // DI17
	{SWITCH_BATT, GPIOD, GPIO9,  GPIO_PUPD_PULLUP, ACTIVE_LOW, DEBOUNCE_LOW},  // DI18
	{SWITCH_RGEN, GPIOD, GPIO8,  GPIO_PUPD_PULLUP, ACTIVE_LOW, DEBOUNCE_LOW},  // DI15
	{SWITCH_LAND, GPIOB, GPIO14,  GPIO_PUPD_PULLUP, ACTIVE_LOW, DEBOUNCE_LOW}, // DI16
	{SWITCH_BCN, GPIOB, GPIO12,  GPIO_PUPD_PULLUP, ACTIVE_LOW, DEBOUNCE_LOW},  // DI13
	{SWITCH_TAXI, GPIOB, GPIO11,  GPIO_PUPD_PULLUP, ACTIVE_LOW, DEBOUNCE_LOW}, // DI14
	{SWITCH_IGNL_S, GPIOD, GPIO6,  GPIO_PUPD_PULLUP, ACTIVE_LOW, DEBOUNCE_LOW}, // DI1
	{SWITCH_IGNL_N, GPIOD, GPIO7,  GPIO_PUPD_PULLUP, ACTIVE_LOW, DEBOUNCE_LOW}, // DI2
	{SWITCH_PWR, GPIOB, GPIO1,  GPIO_PUPD_PULLUP, ACTIVE_LOW, DEBOUNCE_LOW}, // DI11
	{SWITCH_IGNR_S, GPIOD, GPIO1,  GPIO_PUPD_PULLUP, ACTIVE_LOW, DEBOUNCE_LOW}, // DI3
	{SWITCH_IGNR_N, GPIOD, GPIO3,  GPIO_PUPD_PULLUP, ACTIVE_LOW, DEBOUNCE_LOW}, // DI4
	{SWITCH_LNAV, GPIOB, GPIO0,  GPIO_PUPD_PULLUP, ACTIVE_LOW, DEBOUNCE_LOW}, // DI12
	{SWITCH_STROBE, GPIOC, GPIO5,  GPIO_PUPD_PULLUP, ACTIVE_LOW, DEBOUNCE_LOW}, // DI9
	{SWITCH_PAX_SAFE, GPIOD, GPIO0,  GPIO_PUPD_PULLUP, ACTIVE_LOW, DEBOUNCE_LOW}, // DI5
