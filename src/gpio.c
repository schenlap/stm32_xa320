...
gpio_t pin_ins[] = {
	{SWITCH_SW_STBY, GPIOA, GPIO0, GPIO_PUPD_NONE, ACTIVE_HIGH, DEBOUNCE_LOW},
	//{SWITCH_SW_STBY, GPIOe, GPIO7, GPIO_PUPD_PULLUP, ACTIVE_LOW, DEBOUNCE_LOW},
	{SWITCH_NAV,  GPIOC, GPIO8,  GPIO_PUPD_PULLUP, ACTIVE_LOW, DEBOUNCE_LOW},
	{SWITCH_VOR,  GPIOC, GPIO9,  GPIO_PUPD_PULLUP, ACTIVE_LOW, DEBOUNCE_LOW},
	{SWITCH_ILS,  GPIOA, GPIO15, GPIO_PUPD_PULLUP, ACTIVE_LOW, DEBOUNCE_LOW},
	{SWITCH_VOR2, GPIOD, GPIO0,  GPIO_PUPD_PULLUP, ACTIVE_LOW, DEBOUNCE_LOW},
	{SWITCH_ADF,  GPIOD, GPIO2,  GPIO_PUPD_PULLUP, ACTIVE_LOW, DEBOUNCE_LOW},
	{SWITCH_BFO,  GPIOD, GPIO6,  GPIO_PUPD_PULLUP, ACTIVE_LOW, DEBOUNCE_LOW},
	{SWITCH_HF1,  GPIOE, GPIO2,  GPIO_PUPD_PULLUP, ACTIVE_LOW, DEBOUNCE_LOW},
	{SWITCH_HF2,  GPIOE, GPIO6,  GPIO_PUPD_PULLUP, ACTIVE_LOW, DEBOUNCE_LOW},
	{SWITCH_AM,   GPIOE, GPIO15, GPIO_PUPD_PULLUP, ACTIVE_LOW, DEBOUNCE_LOW},
	{SWITCH_VHF1, GPIOE, GPIO13, GPIO_PUPD_PULLUP, ACTIVE_LOW, DEBOUNCE_LOW},
	...
	{SWITCH_RMP_ON, GPIOB, GPIO8, GPIO_PUPD_PULLUP, ACTIVE_LOW, DEBOUNCE_LOW}
};
